...
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "Plany";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "help@plany.tn";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "Plany.tn, Inc.";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "Plant";
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "Plany.tn";
